...
export default class Mapping<TSource, TDestination> {
  /** The list of mapping */
  mapsList: {
    /** The wanted property from source object */
    sourcePredicate: (object: TSource) => any;
    /** The wanted property from destination object */
   ...
   * @param {(object: TDestination) => destination} destinationPredicate (optional) A field of TDestination object.
   * @param {IMappingOptions} options (optional) An object that represents your wanted configurations for the current mapping.
